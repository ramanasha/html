...
<html lang="en" dir="ltr">
  ...
  <body>
    <form class="double" action="test1.php" method="post">
      <h3>Student</h3>
       ...
       <label>
         <input type="checkbox" name="subject[]" value="English" id="subject"> English<br>
       </label>
       <label>
         <input type="checkbox" name="subject[]" value="Tamil" id="subject" checked> Tamil<br><br>
       </label>
